...
[`SET_NUI_FOCUS`](https://docs.fivem.net/natives/?_0x5B98AE30) native, which will set keyboard focus and/or mouse cursor focus depending on the
provided arguments.
...
## NUI messages
You can send a [message][mdn-messages] to the current resource's NUI page using <span class="l-no-lua">the [`SEND_NUI_MESSAGE`](https://docs.fivem.net/natives/?_0x78608ACB)
