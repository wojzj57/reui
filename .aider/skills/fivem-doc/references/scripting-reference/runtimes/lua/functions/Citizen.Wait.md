...
2. **Avoid calling heavy natives per-tick**: Don't call expensive native calls like [`START_EXPENSIVE_SYNCHRONOUS_SHAPE_TEST_LOS_PROBE`](https://docs.fivem.net/natives/?_0x377906D8A31E5586) per-frame if it can be avoided.
3. **Cache frequently called natives**: Certain natives like [`PLAYER_PED_ID`](https://docs.fivem.net/natives/?_0xD80958FC74E988A6) and [`GET_PLAYER_PED`](https://docs.fivem.net/natives/?_0x43A66C31C68491C0) change infrequently, you can cache these in another `CreateThread` that runs less often to save some native calling overhead.
