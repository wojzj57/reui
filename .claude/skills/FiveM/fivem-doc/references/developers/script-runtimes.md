...
This function should not be used, instead the native [`GET_NUM_RESOURCE_METADATA`](https://docs.fivem.net/natives/?_0x776E864) should be used.

#### GetResourceMetaData

This function should not be used, instead the native [`GET_RESOURCE_METADATA`](https://docs.fivem.net/natives/?_0x964BAB1D) should be used.
