...
After we have the ped and store it in a variable, we get the position of the player ped using [`GET_ENTITY_COORDS`](https://docs.fivem.net/natives/?_0x3FEF770D40960D5A). Since a ped is an entity (the same goes for vehicles and a few other things), this native is used for getting their position. This native, returns an array `number[]`.
