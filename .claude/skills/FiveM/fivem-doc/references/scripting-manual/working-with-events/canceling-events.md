...
### Canceling Events
To cancel an event, use the [`CANCEL_EVENT`](https://docs.fivem.net/natives/?_0xFA29D35D) native from within an event handler. This does not stop other event handlers from running.
...
To check if the last event you triggered was canceled, use the [`WAS_EVENT_CANCELED`](https://docs.fivem.net/natives/?_0x58382A19) native. This only works for **local** events.
