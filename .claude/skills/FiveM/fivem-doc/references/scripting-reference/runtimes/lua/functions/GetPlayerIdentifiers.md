...
> [!NOTE]
> If you only need to get a single identifier you can use [`GET_PLAYER_IDENTIFIER_BY_TYPE`](https://docs.fivem.net/natives/?_0xA61C8FC6), if you need to get multiple you should use the below example.
